...
const mockPassageiros: Passageiro[] = [
  { id: 'p1', passeioId: '1', nomeCompleto: 'Ana Clara Souza', dataNascimento: '1990-05-10', cpf: '111.222.333-44', whatsapp: '(83) 99101-2233', contatoEmergencia: '(83) 90000-0000', endereco: { logradouro: 'Rua A', bairro: 'Bessa', cidade: 'João Pessoa', estado: 'PB' }, pontoEmbarque: 'Centro', formaPagamento: 'pix', statusAlocacao: 'alocado', numeroPoltrona: 3 },
  { id: 'p2', passeioId: '1', nomeCompleto: 'Carlos Mendes', dataNascimento: '1985-08-20', cpf: '222.333.444-55', whatsapp: '(83) 98877-5544', contatoEmergencia: '(83) 90000-0000', endereco: { logradouro: 'Rua B', bairro: 'Bessa', cidade: 'João Pessoa', estado: 'PB' }, pontoEmbarque: 'Shopping', formaPagamento: 'cartao_credito', statusAlocacao: 'alocado', numeroPoltrona: 5 },
  { id: 'p3', passeioId: '1', nomeCompleto: 'Fernanda Lima', dataNascimento: '1995-12-01', cpf: '333.444.555-66', whatsapp: '(83) 99234-6677', contatoEmergencia: '(83) 90000-0000', endereco: { logradouro: 'Rua C', bairro: 'Bessa', cidade: 'João Pessoa', estado: 'PB' }, pontoEmbarque: 'Praça', formaPagamento: 'dinheiro', statusAlocacao: 'alocado', numeroPoltrona: 8 },
  { id: 'p4', passeioId: '1', nomeCompleto: 'João Pedro Alves', dataNascimento: '1992-03-15', cpf: '444.555.666-77', whatsapp: '(83) 99321-8899', contatoEmergencia: '(83) 90000-0000', endereco: { logradouro: 'Rua D', bairro: 'Bessa', cidade: 'João Pessoa', estado: 'PB' }, pontoEmbarque: 'Centro', formaPagamento: 'pix', statusAlocacao: 'alocado', numeroPoltrona: 12 },
  { id: 'p5', passeioId: '1', nomeCompleto: 'Maria das Dores', dataNascimento: '1980-07-25', cpf: '555.666.777-88', whatsapp: '(83) 98811-0022', contatoEmergencia: '(83) 90000-0000', endereco: { logradouro: 'Rua E', bairro: 'Bessa', cidade: 'João Pessoa', estado: 'PB' }, pontoEmbarque: 'Terminal', formaPagamento: 'pix', statusAlocacao: 'alocado', numeroPoltrona: 15 },
  { id: 'p6', passeioId: '2', nomeCompleto: 'Lucas Ferreira', dataNascimento: '1998-09-30', cpf: '666.777.888-99', whatsapp: '(83) 99400-1122', contatoEmergencia: '(83) 90000-0000', endereco: { logradouro: 'Rua F', bairro: 'Bessa', cidade: 'João Pessoa', estado: 'PB' }, pontoEmbarque: 'Centro', formaPagamento: 'dinheiro', statusAlocacao: 'alocado', numeroPoltrona: 2 },
  { id: 'p7', passeioId: '2', nomeCompleto: 'Beatriz Costa', dataNascimento: '2001-01-12', cpf: '777.888.999-00', whatsapp: '(83) 99500-3344', contatoEmergencia: '(83) 90000-0000', endereco: { logradouro: 'Rua G', bairro: 'Bessa', cidade: 'João Pessoa', estado: 'PB' }, pontoEmbarque: 'Centro', formaPagamento: 'cartao_credito', statusAlocacao: 'alocado', numeroPoltrona: 4 },
]
